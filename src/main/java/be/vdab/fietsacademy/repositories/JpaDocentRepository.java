...
public class JpaDocentRepository implements DocentRepository {
    ...
    @Override
    public List<IdEnEmailAdres> findIdsEnAmailAdressen() {
    ...
    public List<AantalDocentenPerWedde> findAantalDocentenPerWedde() {
        return manager.createQuery("select new be.vdab.fietsacademy.queryresults.AantalDocentenPerWedde(d.wedde, count(d)) from Docent d group by d.wedde",
