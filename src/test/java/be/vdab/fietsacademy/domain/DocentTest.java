...
public class DocentTest {
    ...
    public void before() {
        ...
        nogEensDocent1 = new Docent("test", "test", WEDDE, "test@fietsacademy.be", Geslacht.MAN);
    }
    ...
    @Test
    public void negatieOpslagMislukt(){
    ...
    @Test
    public void  eenBijnaamMetEnkeleSpatiesMislukt(){
        assertThatIllegalArgumentException().isThrownBy(() -> docent1.addBijnaam(" "));
    }
    @Test
    ...
    public void eenNullCampusInDeConstructorMislukt() {
        assertThatNullPointerException().isThrownBy(()-> new Docent("test", "test", WEDDE, "test@fietsacademy.be",
                                Geslacht.MAN, null));
    }*/
    @Test
