...
public class TelefoonNrTest {
    ...
    @Test
    public void telefoonNrsZijnGelijksAlsHunNummersGelijkZijn(){
        assertThat(nummer1).isEqualTo(nogEensNummer1);
    }

    @Test
    public void telefoonsNrsZijnVerschillendAlsHunNummersVerschillen(){
    ...
    @Test
    public void gelijkeTelefoonNrsGevenDezelfdeHashChode(){
